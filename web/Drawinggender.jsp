...
<html>
    ...
    <body onload="hpmpGraph()">      
        <script>
            function hpmpGraph() {
                var hp = document.hpmpForm.male.value,
                        mp = document.hpmpForm.female.value,
        ...
        <form name="hpmpForm" method="post">
            <%
                try {
                    ...
                    String strQuery = "select count(*) from Person where gender=1";
            ...
            <%
                try {
                    ...
                    Connection con = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=ManagerFood", "sa", "long");
                    Statement st = con.createStatement();
                    String strQuery2 = "select count(*) from Person where gender=0";
            ...
            <input type="text" name="male"  value="<%=request.getAttribute("test1")%>" hidden>
            <br>
            <input type="text" name="female"   value="<%=request.getAttribute("test2")%>" hidden>
